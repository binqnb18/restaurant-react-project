...
const About = () => {
  ...
  <div class="flex-shrink-0 relative">
      ...
      <div class="absolute bottom-0 right-0 p-6 bg-gray-800 text-white rounded-lg">
  ...
  <div class="flex flex-col justify-center">
      ...
      <p class="mt-2 text-lg text-gray-600">
          At place, we believe that dining is nont just about food, but also about the overall experience. Our staff, renowned for their warmth and dedication, strives to make every visit an unforgettable event.
      </p>
  </div>
</div>
